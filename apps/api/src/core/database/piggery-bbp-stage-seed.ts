...
export const BBP_STAGE_SEED = [
  ...
  { stage_code: 'PRODUCTIVE_SOW', stage_name: 'Productive Sow', stage_category: 'PRODUCTIVE', stage_sequence: 10, min_days_before_move: 0, transition_trigger: 'MANUAL', data_entry_form: 'STANDARD', show_on_animal_card: true, stage_description: 'TDD row 24. A sow in the breeding herd, between cycles rather than inside one.' },
  { stage_code: 'BOAR_AI', stage_name: 'Boar AI', stage_category: 'PRODUCTIVE', stage_sequence: 11, min_days_before_move: 0, transition_trigger: 'MANUAL', data_entry_form: 'STANDARD', show_on_animal_card: true, stage_description: 'TDD row 24. A boar in the AI station; his cycle is semen collection, not gestation.' },
  { stage_code: 'CULLED', stage_name: 'Culled', stage_category: 'DISPOSAL', stage_sequence: 20, min_days_before_move: 0, transition_trigger: 'EVENT_BASED', data_entry_form: 'STANDARD', show_on_animal_card: true, stage_description: 'TDD row 24. Removed from the herd. BBP: closure date, reason, disposal destination and weight are recorded, and a write-off is triggered.' },
  { stage_code: 'DEAD', stage_name: 'Dead', stage_category: 'DISPOSAL', stage_sequence: 21, min_days_before_move: 0, transition_trigger: 'EVENT_BASED', data_entry_form: 'STANDARD', show_on_animal_card: true, stage_description: 'TDD row 24. Mortality. Set through Dispose, which records the disposal type DIED.' },
  { stage_code: 'SOLD', stage_name: 'Sold', stage_category: 'DISPOSAL', stage_sequence: 22, min_days_before_move: 0, transition_trigger: 'EVENT_BASED', data_entry_form: 'STANDARD', show_on_animal_card: true, stage_description: 'TDD row 24. Set through Dispose, which posts the gain or loss against book value.' },
