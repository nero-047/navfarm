...
export class CreateFeedReturnNoteDto {
  @ApiProperty({ example: 'RN-FEED-2026-001' }) @IsString() @IsNotEmpty() return_no: string;
  @ApiProperty({ example: '2026-07-30' }) @IsString() @IsNotEmpty() return_date: string;
  @ApiProperty({ example: 'farm-uuid' }) @IsString() @IsNotEmpty() farm_id: string;
  @ApiProperty({ example: 'item-uuid' }) @IsString() @IsNotEmpty() feed_item_id: string;
  @ApiProperty({ example: 2.5, description: 'Quantity returned in MT' }) @IsNumber() qty_mt: number;
  @ApiProperty({ example: 'EXCESS_FEED', description: 'EXCESS_FEED/DAMAGED_BAGS/QUALITY_REJECT' }) @IsString() @IsNotEmpty() return_reason: string;
  @ApiProperty({ example: 'wh-uuid' }) @IsString() @IsNotEmpty() warehouse_id: string;
  @ApiProperty({ example: 'loc-uuid' }) @IsString() @IsNotEmpty() location_id: string;
  @ApiProperty({ required: false }) @IsString() @IsOptional() notes?: string;
}
