...
export default function Step9Finalize({
  onSubmit,
  isSubmitting,
}: Step9FinalizeProps) {
  return (
    <div className="flex flex-col gap-4 text-center items-center justify-center py-8">
      ...
      <p className="text-(--text-secondary) text-sm max-w-md mt-1">
        Your database is fully seeded and custom parameters are registered.
        Click below to launch your NAVFarm ERP space.
      </p>
      <Button
        onClick={onSubmit}
        disabled={isSubmitting}
        className="mt-6 px-8 py-3 font-bold"
      >
        {isSubmitting
