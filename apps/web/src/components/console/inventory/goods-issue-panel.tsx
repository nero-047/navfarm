      ...
      >
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between pt-2 border-t" style={{ borderColor: "var(--border)" }}>
            <div>
              <p className="text-xs font-bold uppercase tracking-wider" style={S.primary}>Issue Outbound Lines ({lines.length})</p>
              <p className="text-[11px]" style={S.muted}>Inventory stock items and quantities issued out for consumption or transfer.</p>
            </div>
            <Button onClick={addLine} type="button" size="sm" variant="outline" className="text-xs">
              <Plus className="h-3.5 w-3.5 mr-1" /> Add Issue Line
            </Button>
          </div>
