...
const resource: MasterDataConfig = {
  ...
  fields: [
    ...
    { key: "maintenance_frequency_days", label: "Maintenance Frequency (days)", type: "number", helpText: "Days between scheduled services. Logging a completed service auto-calculates the next due date.", section: "Maintenance" },
    { key: "maintenance_cost_per_service", label: "Est. Cost per Service", type: "number", step: "0.01", section: "Maintenance" },
