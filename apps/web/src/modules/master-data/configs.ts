...
const farm: MasterDataConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'text',
      required: true,
      placeholder: 'Green Valley Breeding Farm',
    },
    {
      key: 'farm_type',
      label: 'Farm Type',
    ...
    },
    {
      ...
      helpText:
        'Leave blank if this farm is shared across all business verticals.',
    },
    {
      key: 'lob_id',
      ...
      dependsOn: 'nob_id',
      helpText:
        'Leave blank if this farm is shared across all LOBs under the selected NOB.',
    },
...
const warehouse: MasterDataConfig = {
  ...
  fields: [
    { key: 'company_id', label: 'Company', type: 'text', hideInForm: true },
    {
      ...
      type: 'select-entity',
      entityEndpoint: '/farm',
      entityValueKey: 'farm_id',
      entityLabelKeys: ['farm_code', 'farm_name'],
    },
    {
      key: 'warehouse_code',
    ...
    },
    {
      ...
      type: 'text',
      required: true,
      placeholder: 'Raw Material Feed Silo 1',
    },
    {
      key: 'warehouse_type',
...
const location: MasterDataConfig = {
  ...
  fields: [
    { key: 'company_id', label: 'Company', type: 'text', hideInForm: true },
    {
      ...
      entityLabelKeys: ['farm_code', 'farm_name'],
      helpText:
        "Set exactly one of Farm / Shed / Warehouse as this location's parent.",
    },
    {
      key: 'shed_id',
      label: 'Parent: Shed',
      type: 'select-entity',
      entityEndpoint: '/shed',
      entityValueKey: 'shed_id',
      entityLabelKeys: ['shed_code', 'shed_name'],
      helpText:
        "Set exactly one of Farm / Shed / Warehouse as this location's parent.",
    },
    {
      ...
      type: 'select-entity',
      entityEndpoint: '/warehouse',
      entityValueKey: 'warehouse_id',
      entityLabelKeys: ['warehouse_code', 'warehouse_name'],
      helpText:
        "Set exactly one of Farm / Shed / Warehouse as this location's parent.",
    },
    {
      key: 'parent_location_id',
      label: 'Parent Location (sub-location nesting)',
      type: 'select-entity',
...
const shed: MasterDataConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'text',
      required: true,
      placeholder: 'Broiler Grow-out Shed 1',
    },
    {
      key: 'shed_type',
      label: 'Shed Type',
      type: 'select',
      required: true,
      options: ['OPEN_SIDED', 'ENVIRONMENTALLY_CONTROLLED', 'SEMI_EC'].map(
    ...
    },
    {
      ...
      entityLabelKeys: ['nob_code', 'nob_name'],
      helpText:
        'Leave blank if this shed is shared across all business verticals.',
    },
    {
      key: 'lob_id',
      label: 'Line of Business',
      ...
      dependsOn: 'nob_id',
      helpText:
        'Leave blank if this shed is shared across all LOBs under the selected NOB.',
    },
    { key: 'capacity', label: 'Capacity', type: 'number' },
  ],
};
...
const itemAttribute: MasterDataConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'select',
      required: true,
      options: ['STRING', 'NUMBER', 'BOOLEAN', 'LIST'].map((v) => ({
        value: v,
        label: v,
      })),
    },
    {
      key: 'list_values',
      label: 'List Options (JSON array)',
      type: 'json',
      helpText:
        'Only used when Value Type = LIST. Example: ["Grade A","Grade B"]',
    },
...
const item: MasterDataConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'text',
      required: true,
      placeholder: 'Cobb Broiler Chicks',
    },
    {
      key: 'item_type',
      label: 'Item Type',
    ...
    },
    {
      ...
      type: 'select',
      options: ['FIFO', 'LIFO', 'WEIGHTED_AVG', 'STANDARD'].map((v) => ({
        value: v,
        label: v.replace(/_/g, ' '),
      })),
    },
    ...
    {
      key: 'attributes',
      label: 'Attribute Values (JSON array)',
      type: 'json',
      jsonListKeys: ['attribute_id', 'attribute_value'],
      helpText:
        'Array of { attribute_id, attribute_value }. Define available attributes first under Item Attributes. Example: [{"attribute_id":"...","attribute_value":"8.5"}]',
    },
  ],
};
...
const medicine: MasterDataConfig = {
  ...
  fields: [
    { key: 'company_id', label: 'Company', type: 'text', hideInForm: true },
    {
      ...
      filterOnly: true,
      helpText:
        "Scopes the Item picker below — medicines aren't NOB/LOB-scoped themselves.",
    },
    {
      key: 'lob_id',
      label: 'Line of Business',
    ...
    },
    {
      ...
      label: 'Composition',
      type: 'text',
      placeholder: 'Amoxicillin 10% w/w',
    },
    ...
    },
    {
      ...
      type: 'select',
      options: ['ORAL', 'INJECTION', 'WATER', 'TOPICAL'].map((v) => ({
        value: v,
        label: v,
      })),
    },
...
const resource: MasterDataConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'select',
      required: true,
      options: ['LABOR', 'EQUIPMENT', 'VEHICLE'].map((v) => ({
        value: v,
        label: v,
      })),
    },
...
const glMapping: MasterDataConfig = {
  ...
  idKey: 'mapping_id',
  group: 'Finance',
  columns: [{ key: 'transaction_type', label: 'Transaction Type' }],
  fields: [
    { key: 'company_id', label: 'Company', type: 'text', hideInForm: true },
    {
