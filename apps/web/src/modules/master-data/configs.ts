...
const location: MasterDataConfig = {
  ...
  fields: [
    ...
    { key: "location_level", label: "Hierarchy Level", type: "number", hideInForm: true, helpText: "Auto-computed from Parent Location (root = 1, else parent's level + 1)." },
    {
    ...
    { key: "max_capacity", label: "Max Capacity", type: "number", step: "0.01", required: true },
    { key: "capacity_uom", label: "Capacity UOM", type: "select-entity", required: true, entityEndpoint: "/uom", entityValueKey: "uom_code", entityLabelKeys: ["uom_code", "uom_name"] },
    ...
    { key: "silo_capacity_kg", label: "Silo Capacity (KG)", type: "number", step: "0.01", requiredWhen: { anyOf: [{ key: "location_type", equals: "SILO" }] }, helpText: "Required for SILO locations." },
    { key: "silo_reorder_days", label: "Silo Reorder Days", type: "number", requiredWhen: { anyOf: [{ key: "location_type", equals: "SILO" }] }, helpText: "Required for SILO locations. Alerts when stock covers fewer than this many days." },
