...
export function TenantAdminPage() {
  ...
  const metrics: Array<[string, string | number, LucideIcon, string]> = [
    ...
    ['Consolidated output', '₹ 1.24Cr', BarChart3, 'Demo management value'],
  ];
