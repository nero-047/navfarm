...
function Badge({
  ...
  return (
    <span
      className={`inline-flex items-center gap-1 text-[11px] font-semibold border px-2.5 py-0.5 rounded-full ${cls[color]}`}
    >
      {children}
    </span>
  );
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6 p-4 sm:p-6 xl:p-8">
              ...
              <div className="flex flex-wrap gap-2">
                {nobs
                  ...
                  .map((n) => (
                    <div
                      key={n.nob_id}
                      className="rounded-lg border px-3 py-2 text-xs font-bold flex flex-col gap-1"
                      style={{
                      ...
                      <div className="flex flex-wrap gap-1 mt-1">
                        {lobs
                          ...
                          .map((l) => (
                            <span
                              key={l.lob_id}
                              className="text-[10px] font-normal px-2 py-0.5 rounded bg-black/20 text-white"
                            >
                              {l.lob_name}
                            </span>
                          ))}
      ...
      >
        ...
        {!isSystemTenant && (
          <button
            ...
            className="min-h-10 rounded-lg bg-[#101b52] px-4 text-sm font-semibold text-white hover:bg-[#17266d]"
          >
            Change plan
          </button>
        )}
        ...
        <form onSubmit={handleUpgrade} className="space-y-5">
          <div>
            ...
            <select
              ...
              className="min-h-11 w-full rounded-lg border px-4 text-sm"
              style={S.input}
            >
            ...
            <thead>
              <tr className="border-b" style={S.raised}>
                {[
                  ...
                  <th
                    key={h}
                    className="text-left px-4 py-3 text-[11px] font-bold uppercase tracking-wider whitespace-nowrap"
                    style={S.muted}
                  >
                    {h}
                  </th>
                                          ...
                                          <thead>
                                            ...
                                            >
                                              {[
                                                ...
                                                <th
                                                  key={h}
                                                  className="text-left px-4 py-2.5 text-[10px] font-bold uppercase tracking-wider"
                                                  style={S.muted}
                                                >
                                                  {h}
                                                </th>
      ...
      {showSectorModal && (
        ...
        >
          <div
            className="rounded-xl border shadow-2xl w-full max-w-2xl my-auto"
            style={S.surface}
          >
            <div
            ...
            <div className="px-6 py-5 space-y-4">
              ...
              <div className="flex gap-3 pt-3 border-t" style={S.border}>
                ...
                <button
                  type="button"
                  onClick={() => setShowSectorModal(false)}
                  className="px-5 py-2.5 text-sm font-medium rounded-lg border cursor-pointer"
