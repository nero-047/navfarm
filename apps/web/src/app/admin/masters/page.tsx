...
const inputCls =
  'w-full border rounded-[var(--radius-sm)] px-3 py-2 text-sm focus:outline-none';
    ...
    <div className="mx-auto max-w-7xl space-y-6 p-4 sm:p-6 xl:p-8">
      ...
      <div>
        ...
        <p className="text-sm mt-0.5" style={S.sub}>
          Manage global seed data: NOBs, LOBs, Currencies, Languages
        </p>
      </div>
          ...
          {activeTab === 'nobs' && (
            <div className="space-y-4">
              ...
              <Dialog
                ...
                description="Create a configurable farming vertical for company setup."
                maxWidth="md"
              >
                <form
                ...
                >
                  ...
                  <div className="col-span-2 flex flex-col-reverse gap-3 border-t border-(--border-subtle) pt-5 sm:flex-row sm:justify-end">
                    <button
                      type="submit"
                      disabled={savingNob}
                      className="h-11 rounded-[var(--radius-md)] bg-(--accent) px-5 text-sm font-semibold text-white hover:bg-(--accent-hover) disabled:opacity-50"
                    >
                    ...
                    <button
                      ...
                      className="h-11 rounded-[var(--radius-md)] border border-(--border) bg-(--surface) px-5 text-sm text-(--text-secondary) hover:bg-(--surface-raised)"
                    >
                      Cancel
                    </button>
                  </div>
              ...
              <div className="space-y-2">
                {nobs.length === 0 && (
                  <p className="text-sm text-center py-4" style={S.muted}>
                    No NOBs configured.
                  </p>
                )}
                {nobs.map((nob) => {
                    ...
                    >
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <span
                            className="text-xs font-mono border rounded px-2 py-0.5"
                          ...
                          {loadingLobs[nob.nob_id] ? (
                            ...
                            <div className="flex flex-wrap gap-2">
                              {(lobs[nob.nob_id] || []).map((lob: any) => (
                                <span
                                  key={lob.lob_id}
                                  className="text-xs border rounded-[var(--radius-sm)] px-2.5 py-1 font-medium"
          ...
          {activeTab === 'currencies' && (
            <div className="space-y-4">
              ...
              <Dialog
                ...
                title="Add currency"
                description="Add a reporting or accounting currency to the system catalog."
                maxWidth="md"
              >
                <form
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3">
                ...
                {currencies.map((curr) => (
                  <div
                    key={curr.iso_code}
                    className="border rounded-[var(--radius-sm)] p-4 text-center shadow-sm"
                    style={S.raised}
                  >
                    <div className="text-2xl font-black mb-1" style={S.primary}>
                      {curr.symbol}
                    </div>
                    <div className="text-xs font-bold" style={S.primary}>
                      {curr.iso_code}
                    </div>
                    <div className="text-xs mt-0.5 truncate" style={S.muted}>
                      {curr.currency_name}
                    </div>
                    {curr.is_system_default && (
                      <span
                        className="mt-1.5 inline-block text-xs font-bold px-2 py-0.5 rounded"
                        style={{
                          backgroundColor: 'var(--accent-muted)',
                          color: 'var(--accent)',
                        }}
          ...
          {activeTab === 'languages' && (
            <div className="space-y-4">
              ...
              <Dialog
                ...
                title="Add language"
                description="Add a supported interface language and script direction."
                maxWidth="md"
              >
                <form
                  ...
                  <tbody>
                    ...
                    {languages.map((lang) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3" style={S.sub}>
