...
const emptyPlan = {
  ...
  feature_flags: { qr_traceability: false, api_access: false } as Record<
    string,
    boolean
  >,
};
...
export default function AdminPlansPage() {
  ...
  const handleOpen = (plan?: any) => {
    ...
    if (plan) {
      ...
      setForm({
        ...emptyPlan,
        feature_flags: { qr_traceability: false, api_access: false },
      });
    }
    setShowForm(true);
  };
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6 p-4 sm:p-6 xl:p-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold" style={s.text}>
            Subscription Plans
          </h1>
        ...
        <button
          onClick={() => handleOpen()}
          className="flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white rounded-[var(--radius-sm)] shadow-sm transition-colors"
      ...
      <Dialog
        ...
        description="Set billing, capacity, and feature availability."
        maxWidth="lg"
      >
        <form
          onSubmit={handleSave}
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setForm({ ...form, storage_limit_gb: e.target.value })
              }
              className={inputCls}
              style={s.input}
            />
          ...
          <div className="sm:col-span-2 lg:col-span-3 flex items-center gap-6">
            ...
            >
              <input
                type="checkbox"
                checked={!!form.feature_flags?.qr_traceability}
                onChange={(e) =>
                  setForm({
                    ...form,
                    feature_flags: {
                      ...form.feature_flags,
                      qr_traceability: e.target.checked,
                    },
                  })
                }
            ...
            >
              <input
                type="checkbox"
                checked={!!form.feature_flags?.api_access}
                onChange={(e) =>
                  setForm({
                    ...form,
                    feature_flags: {
          ...
          <div className="flex flex-col-reverse gap-3 border-t border-(--border-subtle) pt-5 sm:col-span-2 sm:flex-row sm:justify-end lg:col-span-3">
            <button
              type="submit"
              disabled={saving}
      ...
      {/* Plans Table */}
      <div
        className="rounded-[var(--radius-sm)] border overflow-hidden shadow-sm"
        style={s.surface}
      >
          ...
          <tbody>
            ...
            {plans.map((plan) => (
              <tr
                ...
                style={s.border}
              >
                <td className="px-4 py-3 font-mono text-xs" style={s.muted}>
                  {plan.plan_id}
                </td>
                <td className="px-4 py-3 font-semibold" style={s.text}>
                  {plan.plan_name}
                </td>
                ...
                <td className="px-4 py-3 text-center">
                  {plan.feature_flags?.qr_traceability ? (
                    <CheckCircle className="w-4 h-4 text-green-500 mx-auto" />
                  ) : (
                    <X className="w-4 h-4 mx-auto" style={s.muted} />
                  )}
                </td>
                <td className="px-4 py-3 text-center">
