        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          ...
          <div className="md:col-span-8 space-y-10 text-sm text-gray-300 leading-relaxed">
            ...
            <section id="isolation" className="scroll-mt-24 space-y-3">
              ...
              <p>
                At NAVFarm, we employ a strict multi-tenant architecture designed to ensure total isolation of client data. Every registered Tenant account is provisioned with a completely separate physical or logical database schema (e.g. <code>tenant_shortcode</code>).
              </p>
              <p>
                Your operational farm records, livestock counts, feed formulations, and financial books can never be accessed, mixed, or viewed by other tenants on the platform. All access credentials and database parameters are cryptographically secured.
              </p>
            </section>
            ...
            <section id="collection" className="scroll-mt-24 space-y-3">
              ...
              <p>
                To provide comprehensive ERP services, we collect parameters relating to your business operations:
              </p>
              <ul className="list-disc pl-5 space-y-1 text-gray-400 text-xs">
                <li><strong>Tenant Account Info</strong>: Admin name, email address, password hashes, and invoicing emails.</li>
                <li><strong>Company Metadata</strong>: Corporate registration details, tax identifiers (GSTIN/VAT/EIN), country of operations, and local timezones.</li>
                <li><strong>Operational Metrics</strong>: Rearing batch logs, laying percentages, mortality audits, feed weight tracking, and accounting Ledgers.</li>
              </ul>
            </section>
            ...
            <section id="usage" className="scroll-mt-24 space-y-3">
              ...
              <p>
                Your agricultural records are used solely to run your workspace console:
              </p>
              <ul className="list-disc pl-5 space-y-1 text-gray-400 text-xs">
                <li>To calculate biosecurity operational costing and margins.</li>
                <li>To trigger real-time notification alerts (via SMTP or Webhook) regarding coop environment metrics or audit logs.</li>
                <li>To compile automated end-of-month financial reports and balance sheets.</li>
              </ul>
              <p>
                We do not sell, trade, or share operational metrics with third-party advertising companies.
              </p>
            </section>
            ...
            <section id="security" className="scroll-mt-24 space-y-3">
              ...
              <p>
                Our infrastructure matches modern enterprise standard specifications:
              </p>
              <ul className="list-disc pl-5 space-y-1 text-gray-400 text-xs">
                <li><strong>Transport Layer Security (TLS)</strong>: All console data in transit is encrypted using TLS 1.3.</li>
                <li><strong>At-Rest Encryption</strong>: Database disks, credentials, and app password configurations (e.g. SMTP config credentials) are fully encrypted.</li>
                <li><strong>Token-Based Authentication</strong>: Stateful JSON Web Tokens (JWT) isolate and authenticate each request path.</li>
              </ul>
            </section>
            ...
            <section id="compliance" className="scroll-mt-24 space-y-3">
              ...
              <p>
                Depending on your operating country, you retain access controls over your data, including the right to correct registration parameters, invite/revoke user seats, and request full workspace database exports.
              </p>
              <p>
                For data protection inquiries or to request system deletion of your database schema, please contact us at <code>privacy@navfarm.com</code>.
              </p>
            </section>
