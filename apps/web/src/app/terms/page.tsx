        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          ...
          <div className="md:col-span-8 space-y-10 text-sm text-gray-300 leading-relaxed">
            <section id="accounts" className="scroll-mt-24 space-y-3">
              ...
              <p>
                NAVFarm grants you a limited, non-exclusive, non-transferable
                license to access our cloud-based ERP modules.
              </p>
              <p>
                Each Tenant account operates in an isolated workspace. You are
                solely responsible for all actions occurring in your company
                profiles, team configuration assignments, and keeping
                administrative user credentials secure.
              </p>
            </section>
            ...
            <section id="billing" className="scroll-mt-24 space-y-3">
              ...
              <p>
                Workspace capabilities are determined by your chosen SaaS
                subscription plan:
              </p>
              <ul className="list-disc pl-5 space-y-1 text-gray-400 text-xs">
                <li>
                  <strong>Basic Plan</strong> ($99/mo): Maximum 1 company, 5
                  user accounts, and 5 GB file storage.
                </li>
                <li>
                  <strong>Pro Plan</strong> ($199/mo): Maximum 3 companies, 10
                  user accounts, 10 GB file storage, and QR Code traceability
                  engine.
                </li>
                <li>
                  <strong>Enterprise Plan</strong> ($499/mo): Maximum 10
                  companies, 100 user accounts, 100 GB storage limit, and custom
                  API integrations.
                </li>
              </ul>
              <p>
                Subscriptions are billed on a monthly rolling cycle. Failure to
                settle invoices within 14 calendar days will result in automated
            ...
            <section id="sla" className="scroll-mt-24 space-y-3">
              ...
              <p>
                We strive to maintain high system reliability. Our service
                levels provide:
              </p>
              <ul className="list-disc pl-5 space-y-1 text-gray-400 text-xs">
                <li>
                  Standard Support plans offer a guaranteed 99.5% platform
                  uptime availability.
                </li>
                <li>
                  Enterprise plans offer priority tier support and custom SLA
                  guarantees (up to 99.90% uptime).
                </li>
              </ul>
              <p>
                SLA exclusions include scheduled bi-weekly system maintenance
                windows (usually on Sundays between 02:00 and 04:00 UTC) and
                external network transit provider failures.
              </p>
            </section>
            ...
            <section id="api" className="scroll-mt-24 space-y-3">
              ...
              <p>
                For Enterprise customers using direct integrations or automated
                feed systems (like smart sensory weighers, hatcher climate
                controls, or automated egg counts):
              </p>
              <p>
                A default rate limit of 1,000 requests per minute applies to
                standard API endpoints to safeguard database stability. Custom
                limits up to 5,000 calls per minute can be configured
                dynamically by System Administrators.
              </p>
            </section>
            ...
            <section id="termination" className="scroll-mt-24 space-y-3">
              ...
              <p>
                You may cancel your subscription at any time. Upon workspace
                deletion request, your dynamic MySQL database schemas and user
                credentials will be wiped from our disks within 30 days.
              </p>
              <p>
                For subscription inquiries or billing assistance, contact our
                system administration helpdesk at{' '}
                <code>billing@navfarm.com</code>.
              </p>
            </section>
          </div>
        </div>
