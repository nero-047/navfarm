...
function EditMemberModal({ member, roles, isTenantAdmin, onClose, onSaved, allCompanies }: EditModalProps) {
        ...
        <div className="overflow-y-auto max-h-[70vh]">
          ...
          <form onSubmit={handleSave} className="px-6 py-5 space-y-4">
            ...
            <div className="flex items-center gap-3 pt-1">
              <label className="flex items-center gap-2 cursor-pointer select-none text-sm" style={S.primary}>
                <input
                  type="checkbox"
              ...
              {!form.is_active && (
                <span className="text-[11px] font-semibold px-2 py-0.5 rounded" style={{ background: "#FEE2E2", color: "#DC2626", border: "1px solid #FCA5A5" }}>
                  Will be deactivated
                </span>
              )}
            </div>
