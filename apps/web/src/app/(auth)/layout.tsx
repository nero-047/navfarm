...
export default function AuthLayout({
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left branding panel */}
      <div className="hidden md:flex md:w-[55%] bg-(--nf-ink) relative overflow-hidden">
        {/* Decorative circles */}
        ...
        <div className="absolute top-1/3 left-1/4 w-40 h-40 rounded-full bg-(--accent-muted)" />
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div className="animate-fade-in">
            ...
            <p className="text-white/60 text-lg max-w-md leading-relaxed">
              Manage your livestock, crops, and operations from one clean
              dashboard.
            </p>
          </div>
