...
| `/[company]/workspaces/[workspace]/{dashboard,batches,operations,quality,traceability,resources,costing,reports,masters,settings}` | workspace | operations | `CanonicalWorkspaceContent`, workspace support pages and farm-demo modules | nested `/tenants/[t]/companies/[c]/workspaces/[w]/*` | full tuple | exact module plus workspace read/mutation capability | canonical and implemented in mock | dashboard/costing are non-authoritative projections and all resources lack a durable backend | retain distinct typed settings/masters/dashboard boundaries; define production costing/report semantics before integration | backend H |
